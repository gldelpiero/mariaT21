...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/giancarlo/Dropbox/mariaT21/src/state_machine)
  set(state_machine_DEVEL_PREFIX /home/giancarlo/Dropbox/mariaT21/devel)
  ...
  set(state_machine_INSTALL_PREFIX /home/giancarlo/Dropbox/mariaT21/install)
...
if(NOT "/home/giancarlo/Dropbox/mariaT21/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/giancarlo/Dropbox/mariaT21/src/state_machine/${idir}'.  ${_report}")
    endif()
...
set(state_machine_EXPORTED_TARGETS "state_machine_generate_messages_cpp;state_machine_generate_messages_eus;state_machine_generate_messages_lisp;state_machine_generate_messages_nodejs;state_machine_generate_messages_py")
...
set(pkg_cfg_extras "state_machine-msg-extras.cmake")
